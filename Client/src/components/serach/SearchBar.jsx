  ...
  return (
    <div>
      ...
      {searchMyData && searchMyData.length > 0 && (
        <div className="bg-white w-[33%] h-[300px] shadow-2xl border rounded-2xl absolute z-[55] left-[100px] top-[324px]  overflow-y-scroll scrollbar-hide ">
          {searchMyData.map((search) => {
            return (
              <div
                ...
                key={search._id}
              >
                <div className="w-[150px] h-[100px] mx-5">
                ...
                <div className=" w-[80%]">
                  ...
                  <p className="text-[#949494] mt-1">{search.summery}</p>
                </div>
                <Link to={`post/${search._id}`}>
                  <button className="border hover:bg-blue-600 hover:text-white rounded-lg w-[60px]  px-2 text-[10px]">
                    See...
                  </button>
                </Link>
              </div>
