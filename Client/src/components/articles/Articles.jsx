  ...
  return (
    <div className="container mx-auto w-[89%]">
      <div className="flex items-center justify-between mt-10">
        <div className="bg-[#eee] w-[37%] h-[2px]"></div>
        <h1 className="borderArticles text-[28px]  text-[#000] font-extrabold text-center px-5">
          The Latest Blogs
        </h1>
        <div className="bg-[#eee] w-[37%] h-[2px]"></div>
      </div>
      {/* <div className="flex flex-col justify-center text-center mt-20">
        <h2 className="text-[#3b82f6] font-extrabold text-[28px]"></h2>
        <p className="text-[16px] text-[#929191] w-[380px] lg:w-[600px] mt-5 text-center m-auto">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nobis,
          commodi cum! Assumenda, provident. Repellat, eaque veniam nulla,
          quibusdam quisquam iste o
        </p>
      </div> */}
